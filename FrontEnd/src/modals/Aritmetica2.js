        ...
        <>
            <Modal show={props.show} fullscreen="'xl-down'" onHide={reset}>
                <Modal.Header closeButton>
                    <Col>
                        <Modal.Title>{"Suma y Resta "} </Modal.Title>
                    </Col>
                </Modal.Header>
                <Modal.Body>
                    <Row>
...
async function cargarDatos(data) {
    ...
    const {op,a,b}=data; 
    if (op ==1){
        return fetch("http://localhost:3000/SUMA/"+parseInt(a)+"/"+parseInt(b), {
        method: "GET",
        headers: {
        ...
        return fetch("http://localhost:3000/RESTA/"+parseInt(a)+"/"+parseInt(b), {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
